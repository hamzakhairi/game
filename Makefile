...
#    Updated: 2025/02/18 19:42:06 by hkhairi          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = $(MANDATORY_PART)/size_map.c $(MANDATORY_PART)/so_long.c $(MANDATORY_PART)/FloodFill_2.c $(MANDATORY_PART)/read_file.c $(MANDATORY_PART)/valide_map_2.c $(MANDATORY_PART)/handle_keypress_2.c $(MANDATORY_PART)/valide_map.c $(MANDATORY_PART)/FloodFill.c $(MANDATORY_PART)/free_map.c $(MANDATORY_PART)/get_next_line.c $(MANDATORY_PART)/get_next_line_utils.c $(MANDATORY_PART)/init_window.c $(MANDATORY_PART)/handle_keypress.c $(MANDATORY_PART)/render_map.c
OBJ = $(SRC:.c=.o)
NAME = so_long
